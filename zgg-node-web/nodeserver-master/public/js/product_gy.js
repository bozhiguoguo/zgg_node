var productVM = new Vue({
    ...
    created: function() {
        ...
        this.minItem = minItem,
            this.product = pData,
            this.product.serveexp, //服务费始终是总价减官费
                    ...
                    function(res) {
                        ...
                        if (resJson.success && resJson.data) {
                            if (url.indexOf('buyNow') != -1) {
                                ...
                                productVM.animateAddCart(event);
                            }
                        }
                    },
                    function(err) {
