var productVM = new Vue({
    ...
    created: function() {
        ...
        this.minItem = minItem,
            this.product = pData,
            this.product.serveexp = pData.priceTax - pData.publicexp //服务费始终是总价减官费
        this.minBuyNum = minBuyNum;
        this.otherPirce = 0; ////计算其他附加项费用总和
        this.dPirce = dj;
        this.serveexpNum = this.product.serveexp / minBuyNum; //服务费单项金额
    ...
    computed: {
        countPrice: function() {
            ...
            return ((this.product.serveexp + this.product.publicexp + this.freeSelected.publicexp + this.freeSelected.serveexp));
        }
    },
    methods: {
        /**
