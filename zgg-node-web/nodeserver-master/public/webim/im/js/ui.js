...
//       						'<img class="img j-img" src="'+getAvatar(avatar)+'" data-account="' + from + '"/>',
       			           '<img class="img j-img" src="/webim/im/images/default-icon.png" data-account="' + from + '"/>',
            		...
            		msgHtml = ['<div data-time="'+ message.time +'" data-id="'+ message.idClient +'" id="'+ message.idClient +'" data-idServer="'+ message.idServer +'" class="item item-' + buildSender(message) + '">',
//       						'<img class="img j-img" src="'+getAvatar(avatar)+'" data-account="' + from + '"/>',
       			           '<img class="img j-img" src="/webim/im/images/toux_01.png" data-account="' + from + '"/>',
       						showNick?'<p class="nick">' + getNick(from) + '</p>':'',
       						'<div class="msg msg-text j-msg">',
       							'<div class="box">',
       								'<div class="cnt">',
    ...
    buildSysMsgs:function(data,cache){
        ...
        for(var i = 0;i<data.length;i++){
            ...
            if(item.category=="team"){     
                ...
                html += ['<div class="item">',
                            '<img src="/webim/im/images/advanced.png">',
                            '<div class="text">',
        ...
        for(var i = 0;i<data.length;i++){
            ...
            if(scene==="p2p"){
                ...
                if(teamInfo){
                    ...
                    avatar = "/webim/im/images/"+teamInfo.type+".png";
                }else{
                    nick = to+"-->"+getNick(from);
                    avatar = "/webim/im/images/normal.png";
                }   
            }
            html += ['<div class="item">',
                            '<img src="'+avatar+'">',
